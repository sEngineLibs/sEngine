...
abstract Vec3(FVecN) from FVecN to FVecN {
	...
	@:op(a.b)
	function swizzleRead(name:String):Vec3 {
	...
	@:op(++A)
	inline function increment():Vec3 {
		return ++this;
	}

	@:op(A++)
	inline function postincrement():Vec3 {
		return this
		++;
	}

	@:op(--A)
	inline function decrement():Vec3 {
		return --this;
	}

	@:op(A--)
	inline function postdecrement():Vec3 {
		return this
		--;
	}

	@:op(-A)
	inline function negate():Vec3 {
		return -this;
	}
	...
	@:op(A + B) @:commutative
	inline function addFloat(value:FastFloat):Vec3 {
		return this + value;
	}

	@:op(A + B)
	inline function addFVecN(value:FVecN):Vec3 {
		return this + value;
	}

	@:op(A - B)
	inline function subFloat(value:FastFloat):Vec3 {
		return this - value;
	}

	@:op(A - B)
	inline function subFVecN(value:FVecN):Vec3 {
		return this - value;
	}

	@:op(A * B) @:commutative
	inline function mulFloat(value:FastFloat):Vec3 {
		return this * value;
	}

	@:op(A * B)
	inline function mulFVecN(value:FVecN):Vec3 {
		return this * value;
	}

	@:op(A / B)
	inline function divFloat(value:FastFloat):Vec3 {
		return this / value;
	}

	@:op(A / B)
	inline function divFVecN(value:FVecN):Vec3 {
		return this / value;
	}

	@:op(A % B)
	inline function modFloat(value:FastFloat):Vec3 {
		return this % value;
	}

	@:op(A % B)
	inline function modFVecN(value:FVecN):Vec3 {
		return this % value;
	}
