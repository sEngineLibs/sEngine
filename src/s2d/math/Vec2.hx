...
@:nullSafety
#if !macro @:build(s2d.math.SMath.Swizzle.generateFields(2)) #end
abstract Vec2(FastVector2) to FastVector2 from FastVector2 {
	#if !macro
	...
	public inline function log2():Vec2 @:privateAccess {
		return new Vec2(SMath.log2f(x), SMath.log2f(y));
	}
