...
@:access(sys.net.Host)
class NioSocket {
	var sock:java.net.Socket;
	var server:java.net.ServerSocket;
	...
	public function bind(host:Host, port:Int):Void {
		if (boundAddr != null && server.isBound())
			throw "Already bound";
		createServer();
		boundAddr = new InetSocketAddress(host.wrapped, port);
	}
	...
	public static function select(read:Array<NioSocket>, write:Array<NioSocket>, others:Array<NioSocket>,
			?timeout:Float):{read:Array<NioSocket>, write:Array<NioSocket>, others:Array<NioSocket>} {
