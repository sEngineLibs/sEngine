...
abstract class PhysicalObject<This:PhysicalObject<This>> extends se.VirtualObject<This> {
	...
	@observable @:isVar public var z(default, set):Float = 0.0;
	@observable public var transform:Transform = Mat3.identity();
	@observable public var transformOrigin:Vec2 = new Vec2(0.0, 0.0);
